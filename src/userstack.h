...
#define call_with_user_stack_1(fn, a) call_with_user_stack_impl((user_stack_fn)fn, a, NULL)
#define call_with_user_stack_2(fn, a, b) call_with_user_stack_impl((user_stack_fn)fn, a, b)
